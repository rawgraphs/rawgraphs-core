 ...
 */
  ...
  data(_data){
    ...
    return new RAWChart(this._visualModel, _data, this._dataTypes, this._mapping, this._visualOptions)
  }

  dataTypes(_dataTypes){
    if(!arguments.length){ return this._dataTypes}
    return new RAWChart(this._visualModel, this._data, _dataTypes, this._mapping, this._visualOptions)
  }
...
*/
function rawChart(visualModel, config = {}){
  const { data, dataTypes, mapping, visualOptions={}} = config
  const finalVisualOptions  = {
    ...defaultVisualOptions,
    ...visualOptions,
  }
  return new RAWChart(visualModel, data, dataTypes, mapping, finalVisualOptions)
}
